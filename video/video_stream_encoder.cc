...
void VideoStreamEncoder::OnFrame(const VideoFrame& video_frame) {
  ...
  // Yichen
  std::ofstream file;
  file.open("/home/yichen/Downloads/webrtc-data/data-/translate-ts-us.txt",
...
void VideoStreamEncoder::MaybeEncodeVideoFrame(const VideoFrame& video_frame,
  ...
  if (video_frame.adapt_size().adapted) {
    ...
    float norm = 0.00390625; // 1 / 256
    if (transformer.Transform(norm * ypr.yaw,
                              norm * ypr.pitch, 0,
                              norm * ypr.roll,
                              norm * ypr.extra, 0,
    ...
    t_end = clock();
    std::ofstream file;
    file.open("/home/yichen/Downloads/webrtc-data/data-/transform-ms.txt",
        std::fstream::out | std::fstream::app);
